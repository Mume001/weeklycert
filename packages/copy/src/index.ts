...
export const copy = {
  ...
  imports: {
    ...
    history: {
      ...
      by: 'by {Name}',
      open: 'Open',
      noWeek: 'Not for a week',
    },
    kinds: {
      hours: {
        label: 'Hours by day',
        hint: 'Worker, date and hours, from a time-tracking export.',
      },
      payroll: {
        label: 'Payroll',
        hint: 'Gross, deductions and net per worker, from your payroll system.',
      },
      workers: {
        label: 'Workers',
        hint: 'Your crew: names, numbers, classifications and addresses.',
      },
    },
    status: {
      uploaded: 'Uploaded',
    ...
    sources: {
      ...
      quickbooks_payroll: 'QuickBooks Online Payroll',
      adp: 'ADP',
      gusto: 'Gusto',
      paychex: 'Paychex',
      busybusy: 'busybusy',
    ...
    upload: {
      title: 'New import',
      kind: 'What are you importing?',
      project: 'Project',
      weekEnding: 'Week ending',
      source: 'Where is the file from?',
      file: { label: 'File', hint: 'CSV or XLSX, up to 10 MB. Nothing in the file is ever run.' },
      submit: 'Upload and continue',
      errors: {
        projectRequired: 'Pick a project.',
        weekRequired: 'Pick the week ending.',
        fileRequired: 'Choose a file.',
      },
      refused: {
        tooBig: 'This file is over 10 MB. Export one week at a time, or fewer columns.',
        xls: 'This is an old Excel file (.xls). Save it as .xlsx or .csv and upload again.',
        macros: 'This workbook contains macros. Save it as a plain .xlsx or .csv and upload again.',
        unzippedTooBig:
        ...
        empty: 'This file has no rows under its header row.',
        unreadable: 'We could not read this file. Export it again as CSV.',
      },
      duplicate:
    ...
    mapping: {
      ...
      columns: { field: 'Field', column: 'Column in your file', samples: 'First rows' },
      confidence: { sure: 'Sure', likely: 'Likely', check: 'Check' },
      none: 'Not in this file',
      required: 'Required',
      profileLoaded: 'These columns were matched from your profile {Profile}.',
      targets: {
        worker: 'Worker',
        date: 'Date',
        hours: 'Hours',
        ...
        'deduction:state_tax': 'State income tax',
        'deduction:local_tax': 'Local income tax',
        'deduction:fica': 'Social Security',
        'deduction:medicare': 'Medicare',
        'deduction:sdi': 'NY disability (SDI)',
        'deduction:pfl': 'NY paid family leave',
        'deduction:union_dues': 'Union dues',
        'deduction:garnishment': 'Garnishment',
        'deduction:insurance': 'Insurance',
        'deduction:retirement_401k': '401(k)',
        'deduction:other': 'Other deductions',
        fullName: 'Full name',
      ...
      duplicates: {
        ...
        sum: 'Add the hours together',
        last: 'Keep the last row',
      },
      saveProfile: 'Save as a profile',
      profileName: 'Profile name',
      missing: 'Pick a column for {Field}.',
      submit: 'Check the rows',
    },
    check: {
      columns: {
        row: 'Row',
      ...
      status: { ok: 'Ready', warn: 'Warning', error: 'Error', skipped: 'Skipped' },
      firstRows: 'The first 50 rows are shown.',
      messages: {
        workerNotFound: 'No worker with this name or number.',
        dateUnreadable: 'This date cannot be read.',
        hoursUnreadable: 'These hours cannot be read.',
        hoursNegative: 'Hours cannot be negative.',
        hoursOver24: 'More than 24 hours in one day.',
        classificationUnknown: 'This classification or job code is not on the project.',
        grossUnreadable: 'The gross cannot be read.',
        amountUnreadable: 'An amount cannot be read.',
        ...
        workerInactive: 'This worker is inactive.',
        duplicate: 'The same worker, day and classification appear more than once.',
        overwrites: 'Replaces hours already in the week.',
        workerExists: 'This worker exists already, left out.',
      },
      matchWorker: 'Match {Name} to',
      matchCode: 'Match {Code} to',
      ...
      stillErrors_one:
        '{n} row still has an error. Fix it in the file, match it above, or skip it.',
      stillErrors_other:
        '{n} rows still have an error. Fix them in the file, match them above, or skip them.',
    },
    reconcile: {
      titleHours: 'Hours in the file, by worker',
      titlePayroll: 'Gross in the file, by worker',
      columns: {
        worker: 'Worker',
        inFile: 'In the file',
      ...
      note: 'Check the difference before you confirm. The most common import mistake is a missing paycheck.',
      none: 'None',
    ...
    detail: {
      ...
      confirmBody: 'What it brought in is taken out again. Hours typed by hand stay.',
      confirm: 'Undo import',
      undone: 'Import undone.',
      locked: 'This week is signed, so the import cannot be undone. Create a correction instead.',
      expired: 'An import can be undone for 90 days.',
    },
  },
